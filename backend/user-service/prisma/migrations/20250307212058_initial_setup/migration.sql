-- CreateEnum
CREATE TYPE "LevelType" AS ENUM ('L1', 'L2', 'L3');

-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('PENDING', 'REJECTED', 'ACCEPTED');

-- CreateEnum
CREATE TYPE "RejectionReason" AS ENUM ('NONE', 'AI_DETECTED', 'PROXY_DETECTED', 'SKILL_MISMATCH', 'OTHER');

-- CreateEnum
CREATE TYPE "InterviewStatus" AS ENUM ('SCHEDULED', 'COMPLETED', 'FAILED');
...
CREATE TABLE "Interview" (
    ...
    "jobId" TEXT NOT NULL,
    "interviewerId" TEXT,
    "aiAssessment" BOOLEAN NOT NULL DEFAULT false,
    "status" "InterviewStatus" NOT NULL DEFAULT 'SCHEDULED',
    "interviewLevel" "LevelType" NOT NULL,
    "comments" TEXT,
    "rejectionReason" "RejectionReason",
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "Interview_candidateId_jobId_interviewLevel_idx" ON "Interview"("candidateId", "jobId", "interviewLevel");
...
-- AddForeignKey
ALTER TABLE "JobLevel" ADD CONSTRAINT "JobLevel_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "Job"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
